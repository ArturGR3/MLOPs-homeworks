...
from modules.cloud_storage_handler import (
    CloudStorageHandler,
)  # Adjust the import to match the new class name
...
def test_upload_download_s3(handler):
    local_file = f"{project_path}/data/integration_test/local_file.txt"
    s3_file = "s3_file.txt"
    ...
    downloaded_file = f"{project_path}/data/downloaded_local_file.txt"
